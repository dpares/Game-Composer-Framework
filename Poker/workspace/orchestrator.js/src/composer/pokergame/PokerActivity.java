 ...
 */
public class PokerActivity extends ComposerGameActivity {
    ...
    public JSONObject getCommonDataJSON() {
        try {
            ...
            throw new ComposerGameException("Error parsing commonData into JSON", e);
        }
    }
    ...
    public void showResults(JSONObject winners, JSONArray players, JSONObject commonData) {
        ...
        try {
            ...
            throw new ComposerGameException("Error parsing commonData in showResults", e);
        }
    }
